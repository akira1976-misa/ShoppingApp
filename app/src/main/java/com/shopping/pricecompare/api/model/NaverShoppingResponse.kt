...
data class NaverShoppingResponse(
    val total: Int = 0, val start: Int = 0, val display: Int = 0,
    val items: List<NaverShoppingItem> = emptyList()
)
data class NaverShoppingItem(
    val title: String = "", val link: String = "", val image: String = "",
    val lprice: String = "0", val hprice: String = "0", val mallName: String = "",
    val productId: String = "", val productType: String = "2",
    val brand: String = "", val maker: String = "",
