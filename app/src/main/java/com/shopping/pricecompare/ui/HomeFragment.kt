...
class HomeFragment : Fragment() {
    ...
    private fun observeViewModel() {
        ...
        vm.sections.observe(viewLifecycleOwner) { sections ->
            ...
            sections.forEach { section ->
                val sv = LayoutInflater.from(requireContext()).inflate(R.layout.item_category_section, b.hotDealsContainer, false)
                ...
                rv.adapter = adapter; rv.isNestedScrollingEnabled = false
    ...
    private fun goToDetail(p: Product) {
        startActivity(Intent(requireContext(), ProductDetailActivity::class.java).putExtra("product", p as java.io.Serializable))
    }
